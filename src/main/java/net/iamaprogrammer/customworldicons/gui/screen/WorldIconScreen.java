package net.iamaprogrammer.customworldicons.gui.screen;

import com.google.common.collect.Maps;
import com.mojang.logging.LogUtils;
import net.fabricmc.api.EnvType;
import net.fabricmc.api.Environment;
import net.iamaprogrammer.customworldicons.gui.widgets.WorldIconListWidget;
...
public class WorldIconScreen extends Screen {
    ...
    @Nullable
    private net.iamaprogrammer.customworldicons.gui.screen.WorldIconScreen.DirectoryWatcher directoryWatcher;
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawText(this.textRenderer, this.title, this.width / 2, 8, 0xFFFFFF, true);
        context.drawText(this.textRenderer, DROP_INFO, this.width / 2, 20, 0xFFFFFF, true);
    ...
    public void filesDragged(List<Path> paths) {
        ...
        this.client.setScreen(new ConfirmScreen(confirmed -> {
            if (confirmed) {
                net.iamaprogrammer.customworldicons.gui.screen.WorldIconScreen.copyPacks(this.client, paths, this.file);
                this.refresh();
            }
    ...
    static class DirectoryWatcher
        ...
        @Nullable
        public static net.iamaprogrammer.customworldicons.gui.screen.WorldIconScreen.DirectoryWatcher create(Path path, WorldIconScreen screen) {
            try {
                return new net.iamaprogrammer.customworldicons.gui.screen.WorldIconScreen.DirectoryWatcher(path, screen);
            } catch (IOException iOException) {
